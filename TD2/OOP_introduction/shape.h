...
float get_area_rectangle_base(const Shape *shape);
float get_area_triangle_base(const Shape *shape);
float get_area_circle_base(const Shape *shape);
float get_area_square_as_shape_base(const Shape *shape);
